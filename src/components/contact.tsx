          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Ready to transform your vision into reality? Connect with our
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                ...
                <div className="space-y-6">
                  <div className="flex items-start sm:items-center group gap-4 sm:gap-0">
                    ...
                    <div>
                      ...
                      <div className="text-gray-300">${phone_no}</div>
              ...
              <div className="glass-card rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 hover:bg-white/10 transition-all duration-300 order-1 md:order-2">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    <input
                      ...
                      className="px-3 py-2 sm:px-4 sm:py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-400/50 focus:border-cyan-400/50 transition-all"
                    />
                    <input
                      type="text"
                  ...
                  <div>
                    <input
                      ...
                      className="w-full px-3 py-2 sm:px-4 sm:py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-400/50 focus:border-cyan-400/50 transition-all"
                    />
                  </div>
                  <div>
                    <select className="w-full px-3 py-2 sm:px-4 sm:py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-cyan-400/50 focus:border-cyan-400/50 transition-all">
                  ...
                  <div>
                    <textarea
                      ...
                      className="w-full px-3 py-2 sm:px-4 sm:py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-400/50 focus:border-cyan-400/50 transition-all resize-none"
                    ></textarea>
                  </div>
